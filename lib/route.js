...
RouteSms.prototype.send = function(){
    ...
    if(this.sender.source.length > 11) callback({status:0,message:"Invalid Message Source, Text should not be > 11 char"});
    var dest_string = "";
    ...
    else{callback({status:0,message:"Message destination is currupt or badly formatted"});}
};
